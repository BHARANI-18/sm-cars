        ...
        <ThemeProvider>
          <LanguageProvider>
            <AuthProvider>
              ...
              <a
                href="https://chat.whatsapp.com/K02LdUIykB5GAFaXlJFWVN"
                target="_blank"
                rel="noopener noreferrer"
                className="fixed bottom-6 right-6 bg-[#25D366] hover:bg-[#1ebd57] text-white p-3.5 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 z-50 flex items-center justify-center transform hover:scale-110"
